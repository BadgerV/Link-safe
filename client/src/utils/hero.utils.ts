export const HEROCONTENT = [
  ...
  },
  {
    ...
    description:
      "We reshape crypto for all, driving adoption, nurturing Algorand, and fostering a vibrant developer community—an inviting path to the future of finance and ASAs."
  }
];
